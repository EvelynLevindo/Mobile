...
// Se existir dados do usuário, vai precisar do initState
  @override
  void initState() {
    ...
    if(widget.user != null){
      ...
      _nameInput.text = widget.user!.nome;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(widget.user == null ? "Novo Usuário" : "Editar Usuário ${widget.user!.nome}"),),
